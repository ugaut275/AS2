...
public String toString() {
	return "Category: Animals " + " S_N: " +getS_N()+ " Name is " + getName()+ " Brand is  " + getBrand() +  " Cost: " + getPrice() + " Stock: " + getCount() +" Age restriction " +getAge() + " doll material " + getMaterial() + " Size  " + getSize();
